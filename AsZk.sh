...
apt install curl -y && apt install atd -y
Green="\e[92;1m"
BlueBee="\033[94;1m"
YELLOW="\033[33m"
BLUE="\033[36m"
...
clear;clear;clear
echo -e "${BlueBee}╔════════════════════════════════════════════════╗${NC}"
echo -e "\033[96;1m                 JOY TUNNELING               \033[0m"
echo -e "${BlueBee}╚════════════════════════════════════════════════╝${NC}"
echo ""
echo ""
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/joytun21/lunaip/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/joytun21/lunaip/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/joytun21/lunaip/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/joytun21/libevscripted/main/"
CONFIG="https://raw.githubusercontent.com/joytun21/fodder/main/"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/joytun21/lunaip/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/joytun21/lunaip/main/ip | grep $ipsaya | awk '{print $3}')
...
wget "http://raw.githubusercontent.com/joytun21/libevscripted/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh"
cd
...
./SSH-service.sh
print_succes "SSH AUTOKILL"
}

function udepe_install(){
cd
rm -rf /root/udp
mkdir -p /root/udp
...
echo -e ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
echo -e "\e[96;1m               ----[ JOY TUNNELING ]----                    \e[0m"
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo ""
echo -e "\e[95;1m  Whatsapp : 6283877140463 \e[0m"
echo -e "\e[95;1m  Telegram : @joyhayabuse \e[0m"
echo -e "\e[95;1m  Chanel   : https://t.me/+29-pKOGfLKwwYzI9 \e[0m"
echo ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
...
echo -e " \e[93;1m•\e[0m SSL  / TLS / GRPC /     :  443,8443,2095,2083"
echo -e " \e[93;1m•\e[0m UDP CUSTOM              :  1-65535,1-2222,1-24361 dll. "
echo -e ""
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo -e ""
echo ""
